            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CircleAvatar(
                    radius: 40,
                    backgroundImage: NetworkImage(providerInfo['profileImage'] ??
                        'https://avatar.iran.liara.run/public'), // Fallback image
                  ),
                  SizedBox(height: 20),

                  // Name and Contact Info
                  Text(providerInfo['name'] ?? 'John Doe',
                      style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height: 8),
                  Text(providerInfo['phone'] ?? '+91 9876543210',
